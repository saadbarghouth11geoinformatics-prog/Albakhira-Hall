...
const ROUTE_SEO_MAP: Record<string, RouteMeta> = {
  '/': {
    ...
    description: 'قاعة الباخرة للاحتفالات بجدة (الحرازات). بوفيه مفتوح بطول 10 أمتار فضي، تورتة من 3 أدوار، ضيافة 40 طاولة مجانًا، قسم رجال متكامل مع 100 فرش جلسات حوش، ومؤثرات زفة مجانًا.',
  ...
  '/womens-hall': {
    ...
    description: 'استكشف مواصفات صالة النساء الملكية بقاعة الباخرة بجدة: بوفيه مفتوح بطول 10 أمتار فضي لـ 100 سيدة، تورتة من 3 أدوار، ضيافة 40 طاولة مجانًا، 10 مباشرات ومشرفة، وعاملات فستان العروسة مع المؤثرات المجانية.',
    keywords: 'صالة النساء قاعة الباخرة, قاعة نساء جدة, بوفيه بطول 10 أمتار, تورتة 3 ادوار, ضيافة حلا ومعجنات, كوشة العروسة, كشاف العروسة',
    ogImage: '/Videos/posters/hall-tour.jpg',
  },
  '/mens-hall': {
  ...
  '/offers': {
    ...
    ogImage: '/Videos/posters/table-decor.jpg',
  },
  '/calculator': {
  ...
  '/menu': {
    ...
    keywords: 'منيو قاعة الباخرة, بوفيه مفتوح بطول 10 أمتار, تورتة الزفاف, عشاء افراح جدة, قائمة طعام الحفل',
    ogImage: '/Videos/posters/table-decor.jpg',
  },
  '/reviews': {
    title: 'آراء وتقييمات العرسان والضيوف | قاعة الباخرة بجدة',
    description: 'اقرأ التقييمات الموثقة والانطباعات الحقيقية للعرسان وضيوف قاعة الباخرة بجدة حول جودة البوفيه بطول 10 أمتار، الزفة، الضيافة، والالتزام ببنود العقد.',
  ...
  '/contact': {
    ...
    ogImage: '/Videos/posters/welcome-display.jpg',
  },
};
