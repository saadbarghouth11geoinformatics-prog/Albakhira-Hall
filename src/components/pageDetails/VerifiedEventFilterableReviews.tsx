...
const VERIFIED_REVIEWS: VerifiedReview[] = [
  ...
  },
  {
    ...
    date: 'يوليو 2026',
    stars: 5,
    comment: 'جناح العروسة VIP كان مريح جداً ومزود بمرآة المكياج والمصعد المستقل. أجهزة الليزر والبخار بالكوشة جعلت دخلتي كالأحلام. شكراً للمشرفة مريم على الاهتمام.',
  ...
  },
  {
    ...
    date: 'مايو 2026',
    stars: 5,
    comment: 'الضيافة على الطاولات كانت ممتازة بـ 40 صحن حلا و40 صحن معجنات والعصائر الطبيعية الـ 30 لتر كانت باردة ولذيذة جداً. سعر العرض الشامل منافس جداً بجدة.',
  ...
  },
  {
    ...
    date: 'أبريل 2026',
    stars: 5,
    comment: 'التنظيم في قسم الرجال والنساء كان رائعاً جداً، البوفيه الفضي الفاخر والأصناف كانت سخنة ولذيذة، والصبابين كانوا ممتازين وسريعين بالخدمة.',
  ...
  },
  {
    ...
    date: 'فبراير 2026',
    stars: 5,
    comment: 'مكان القاعة ممتاز بالحرازات ومواقف السيارات كانت واسعة جداً ومظللة اتسعت لكل الحاضرين بدون أي مشكلة.',
  ...
  },
  {
    ...
    date: 'يناير 2026',
    stars: 5,
    comment: 'النظافة والتعقيم الفندقي في صالة النساء والممرات والحمامات كان ممتازاً جداً. نشكر إدارة قاعة الباخرة على حرصهم واهتمامهم الدائم.',
