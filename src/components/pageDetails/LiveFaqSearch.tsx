...
const FAQ_ITEMS: FaqItem[] = [
  ...
  {
    id: '2',
    question: 'هل يتاح تعديل تاريخ الحفل مجاناً؟',
    answer: 'نعم، يحق للعميل طلب تعديل أو ترحيل تاريخ الحفل مجاناً قبل موعد المناسبة بـ 15 يوماً على الأقل، بشرط توفر التاريخ الجديد المفضل في الجدول الملاحي للقاعة.',
