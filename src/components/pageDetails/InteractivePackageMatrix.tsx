...
export const InteractivePackageMatrix: React.FC = () => {
  ...
  const packagesData: Record<string, {
    ...
    'womens-silver-offer': {
      ...
      buffet: 'بوفيه مفتوح بطول 10 أمتار فضي + تورتة من 3 أدوار',
    ...
    'midweek-deal': {
      ...
      buffet: 'بوفيه بطول 10 أمتار + تورتة من 3 أدوار + ضيافة الرجال',
      hospitality: '80 صحن ضيافة طاولات + 30L عصائر طازجة',
      staff: 'طاقم نسائي ورجالي مكتمل (20 فرد)',
      effects: 'شامل كافة المؤثرات والجلسات مجانًا'
    }
  };
