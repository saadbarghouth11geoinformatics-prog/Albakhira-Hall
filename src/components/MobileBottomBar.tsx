...
export const MobileBottomBar: React.FC<MobileBottomBarProps> = ({ onOpenBooking }) => {
  ...
  return (
    <div className="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-[var(--color-warm-white)]/95 backdrop-blur-xl border-t border-[var(--color-border)] px-2 pt-2 pb-safe shadow-[var(--shadow-sm)]">
      <div className="grid grid-cols-5 gap-1 text-center max-w-md mx-auto">
        {/* 1. Quick Booking Button */}
        <button
          onClick={() => onOpenBooking()}
          className="flex flex-col items-center justify-center py-1.5 px-1 rounded-xl bg-[var(--color-champagne-100)] border border-[var(--color-champagne-500)] text-[var(--color-navy-950)] font-bold cursor-pointer active:scale-95 transition-all"
        >
        ...
        <a
          ...
          className="flex flex-col items-center justify-center py-1.5 px-1 rounded-xl text-[var(--color-navy-900)] hover:bg-[var(--color-champagne-100)] transition-colors cursor-pointer"
        >
        ...
        <a
          ...
          className="flex flex-col items-center justify-center py-1.5 px-1 rounded-xl text-[#25D366] hover:bg-[#25D366]/10 transition-colors cursor-pointer"
        >
        ...
        <NavLink
          to="/calculator"
          className={({ isActive }) =>
            `flex flex-col items-center justify-center py-1.5 px-1 rounded-xl transition-colors ${
              isActive
        ...
        >
          ...
          <span className="text-[10px] font-tajawal font-bold text-[var(--color-navy-900)]">الحاسبة</span>
        </NavLink>
