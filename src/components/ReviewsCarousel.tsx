...
const CAROUSEL_SLIDES: ReviewCarouselSlide[] = [
  {
    ...
    rating: 5,
    reviewText:
      'ما شاء الله تبارك الله، العروض مطابقة للورقة تمامًا دون أي زيادة أو تكاليف خفية! البوفيه الفضي الـ 10 متر كان راقي جدًا ولذيذ وشامل لأصناف فندقية، وضيافة الحلا والمعجنات غطت 40 طاولة وزيادة. المباشرات والمشرفة كانوا في قمة اللباقة والنظافة والتنظيم. أنصح كل عريس وعروسة بالباخرة!',
    verifiedBooking: true,
    avatarUrl: '',
    proofBadge: '📸 البوفيه الفضي المفتوح 10m وتورتة من 3 أدوار',
    proofImage: '/Videos/posters/table-decor.jpg',
    proofTitle: 'بوفيه النساء المفتوح 10 متر وتورتة العروسين',
    proofDescription: 'تجهيز الخدمة الفندقية وأطباق الحلويات والمعجنات الطازجة لـ 100 سيدة بالقاعة.',
    keyHighlights: ['بوفيه فضي 10 متر', 'تورتة زفاف 3 دور', '80 صحن حلا ومعجنات مجانًا'],
  },
  {
    id: 'slide-2',
    ...
    proofImage: '/Videos/posters/welcome-display.jpg',
  ...
  },
  {
    ...
    proofImage: '/Videos/posters/hospitality.jpg',
  ...
  },
  {
    ...
    rating: 5,
    reviewText:
      'بصراحة العرض الشامل المعتمد مقابل هذا الكم الهائل من الخدمات يعتبر فرصة لا تتكرر بجدة. البوفيه بطول 10 أمتار، تورتة من 3 أدوار طازجة ولذيذة جدًا، 30 لتر عصير فريش مانجو وجوافة، والدي جي صوتياته نقية وممتازة بدون أي تشويش.',
    verifiedBooking: true,
    avatarUrl: '',
  ...
  },
  {
    ...
    rating: 5,
    reviewText:
      'طاولات النساء كانت مرتبة ومنسقة بدقة، صحون الحلا والمعجنات (40 صحن) كانت كافية لكل الطاولات وطازجة. خدمة المباشرات كانت سريعة جدًا وابتسامتهن ما فارقتهم طوال السهرة.',
    verifiedBooking: true,
    avatarUrl: '',
    proofBadge: '📸 صالة النساء وتنسيق الطاولات المذهبة',
    proofImage: '/Videos/posters/hall-tour.jpg',
  ...
  },
  {
    ...
    rating: 5,
    reviewText:
      'شاشة الـ 4K LED العملاقة على الكوشة كانت واضحة جدًا وعرضت مقاطع حفل التخرج بجودة بصرية ممتازة. قسم الرجال يتسع لمئات الضيوف بكل أريحية.',
    verifiedBooking: true,
    avatarUrl: '',
  ...
  },
  {
    ...
    rating: 5,
    reviewText:
      'التعامل مع إدارة قاعة الباخرة كان سهلاً وواضحاً. أمانة ومصداقية وسرعة في تنفيذ جميع الملاحظات قبل موعد المناسبة بوقت كافٍ.',
    verifiedBooking: true,
    avatarUrl: '',
