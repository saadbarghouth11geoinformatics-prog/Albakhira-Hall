    ...
    <section ref={heroRef} id="hero" className="relative min-h-[58svh] sm:min-h-[64svh] flex items-center justify-center overflow-hidden py-7 sm:py-10 md:py-12 bg-[var(--color-ivory)] text-[var(--color-text)]">
      ...
      >
        ...
        <div className="relative max-w-5xl mb-6 p-2 sm:p-4 text-center">
          ...
          >
            احجز حفل زفافك أو مناسبتك الشاملة في <strong className="inline-block text-[var(--color-champagne-300)] bg-[var(--color-champagne-500)]/25 px-3 py-1 rounded-lg border border-[var(--color-champagne-500)]/50 font-black mx-1 shadow-sm">أفخم قاعات الحرازات بجدة</strong> مع بوفيه مفتوح 10 متر، تورتة 3 دور، وقسم رجال متكامل.
          </motion.p>
        ...
        {/* Location Sub-banner */}
        <div className="mt-8 flex items-center justify-center gap-2 text-xs md:text-sm text-[var(--color-champagne-300)] bg-[var(--color-navy-950)]/80 px-4 py-2 rounded-full border border-[var(--color-champagne-500)]/40 backdrop-blur-md shadow-md">
          <MapPin className="w-4 h-4 text-[var(--color-champagne-500)] shrink-0 animate-pulse" />
          <span className="font-bold">{HALL_SPECS.locationAr}</span>
        </div>
