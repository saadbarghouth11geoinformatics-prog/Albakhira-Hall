...
export const AudioGuideTour: React.FC = () => {
  ...
  const chapters: AudioChapter[] = [
    ...
    },
    {
      ...
      text: 'احجز حفل زفافك في قاعة الباخرة مع عرض شامل يضم القاعة، البوفيه المفتوح بطول 10 أمتار، والتورتة الملكية.'
    },
    {
      id: 3,
      title: 'البوفيه الفاخر 10 متر وتورتة العروسين',
      text: 'استمتع ببوفيه مفتوح امتداد 10 متر يضم المشويات والمأكولات البحرية والمقبلات، مع تورتة زفاف 3 أدوار مجانًا.'
    },
    {
      id: 4,
