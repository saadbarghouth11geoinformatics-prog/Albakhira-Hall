...
export const AboutSection: React.FC = () => {
  const pillars = [
    ...
    {
      icon: Music,
      title: 'شامل الدي جي والمؤثرات مجاناً',
      desc: 'بخار، ليزرات مزدوجة، زفة العروسة، وكشاف المسرح المباشر مشمولة مجاناً.',
    },
    {
      icon: Zap,
      title: 'عصائر طازجة وحلويات على الطاولات',
      desc: '30 لتر عصائر فريش، 40 صحن حلا، و40 صحن معجنات على طاولات النساء مجاناً.',
    },
  ];

  const highlights = [
    'صالة للنساء فخمة ومكيفة بالكامل مع بوفيه 10 متر.',
